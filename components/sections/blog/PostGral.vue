<template>
    <NuxtLink :to='post.uri' >
      <div class="items-center text-secondary transition-all hover:-translate-y-1 hover:scale-105 pb-3">
          <div class="flex flex-col lg:flex-row md:flex-row">
              ...
              <div class="flex-col lg:w-9/12 md:9/12 w-full pl-1 max-sm:h-30 lg:ml-3">
                <p class="text-primary text-xs">{{ post.categories }} - <span class="text-gray-600">{{ new Date(post.date).toLocaleDateString() }}</span></p> 
