    ...
    <NuxtLink :to='post.slug'>
      <div class="items-center text-secondary transition-all hover:-translate-y-1 hover:scale-105 pb-8">
          <div class="flex flex-col lg:flex-row md:flex-row">
              ...
              <div class="flex-col lg:w-9/12 md:9/12 w-full pl-1 max-sm:h-30 lg:ml-3 border-b md:border-none lg:border-none">
                ...
                <p class="text-gray-700 text-sm leading-5 text-justify md:text-left lg:text-left pb-2">{{ cleanAndTruncate(post.excerpt) }}</p>
              </div>
          </div>
      </div>
    </NuxtLink>
