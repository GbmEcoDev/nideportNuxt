<template>
    <section class="relative scroll-snap-align-start ">
            ...
            <div class="flex justify-center items-center mt-8 md:mt-24 lg:mt-24 pb-16 h-[454px] max-sm:flex-col">
                <div class="flex items-center justify-center px-20 w-2/6 h-full max-sm:w-full max-sm:px-2 max-sm:my-8 " >
                ...
                <div class="relative w-4/6 max-sm:w-11/12 h-full">
                    ...
                    <div data-slide-recent @scroll="initScroll()" class="flex items-stretch gap-5 overflow-hidden overflow-x-auto invisible-scroll h-[350px] md:h-full lg:h-full max-sm:w-full max-sm:snap-x">
                            ...
                            <div 
                                class="w-9/12 min-w-[91.666667%] xs:w-80 xs:min-w-[20rem] md:w-2/3 md:min-w-[66.66666%] lg:w-2/4 lg:min-w-[33%] h-full max-sm:snap-center" ><!-- @click="() => toggleModal('PillarTwo')" -->
