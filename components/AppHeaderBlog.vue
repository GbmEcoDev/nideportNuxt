      ...
      <AtomsContainer class="relative">
          <nav class="z-100 flex items-center justify-between w-full relative py-0 ">
              ...
              <div 
                  ...
                  <ul class="text-secondary max-sm:text-secondary max-md:text-secondary max-lg:text-secondary w-full flex lg:items-center gap-y-4 lg:gap-x-8 flex-col lg:flex-row lg:h-20">
